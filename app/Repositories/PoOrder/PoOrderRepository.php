...
END,
  ...
  //   $averageLeadTimeTotal = 0;
  //   $poOrderlist = PoOrder::with(['arrivalItem'])
  ...
  //       //avg order time for each arrival item
  //       $totalLeadTime += $leadTime;
  //       $averageOrderTime =   $totalLeadTime / $totalArrivalItemCount;
  //       $avgOrderTime = $this->formatTime($averageOrderTime);

  //       // Store item-level details
  //       $itemsData[] = [
  //         'item_id' => $poOrder->item->id,
  //         'item_name' => $poOrder->item->name,
  //         // 'avg_leadtime' => $this->formatTime($avgLeadtime),
  //         'average_order_time' => $avgOrderTime,
  //       ];
  //     }
  //   }

  //   $totalAverageOrderTimeFormatted =  $this->formatTime($totalAvgLeadTime);
  //   $result[] = [
  //     'supplier_id' => $supplierId,
  //     'supplier_name' => $poOrder->supplier->name,
  //     'total_average_lead_time' => isset($totalAverageOrderTimeFormatted) ? $totalAverageOrderTimeFormatted : 'N/A',
  //     'details' => $itemsData,
  //   ];
