    ...
    public function run()
    {
        ...
        $itemBalances = DB::table('inventory_ledger_items')
            ...
            ->select(
                ...
                'items.uom_id as item_uom_id as base_unit_id',
            ...
            ->groupBy('inventory_ledger_items.item_id', 'items.name', 'latest_prices.uom_id', 'items.uom_id', 'uom_conversions.conversion');
