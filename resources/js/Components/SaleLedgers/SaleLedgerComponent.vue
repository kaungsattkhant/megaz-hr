            ...
            <div class="overflow-x-auto">
                ...
                <div class=" table-container ">
                    <table class="primary-table">
                        <thead class="">
                            <tr class="border-b">
                                <th scope="col" class="text-center border-r" rowspan="2">
                                    Date
                                </th>
                                <th scope="col" class=" text-center border-r" colspan="6">
                                    Restaurant
                                </th>
                                <th scope="col" class="text-center" colspan="6">
                                    KTV
                                </th>
                                <th scope="col" class="text-right border-l !pr-4" rowspan="2">
                                    Amount
                                </th>
                            </tr>
                            <tr>
                                ...
                                <th scope="col" class="text-right border-r">
                                    SubTotal
                                </th>
                                <th scope="col" class=" text-right">
                                    Food
                        ...
                        <tbody>
                            <div class="contents" v-for="(item, index) in primaryList" :key="index">
                                <tr class="">
                                    ...
                                    <td class="whitespace-nowrap text-right ">
                                        {{ item.Beverage_Total_ktv }}

                                    </td>
                                    <td class="whitespace-nowrap text-right">
                                        {{ item.Room_Charges_ktv }}

                                    </td>
                                    <td class="whitespace-nowrap text-right">
                                        {{ item.Other_Charges_ktv }}

                                    </td>
                                    <td class="whitespace-nowrap text-right">
                                        {{ item.Service_Charge_ktv }}
                                    ...
                                    <td class="whitespace-nowrap text-right">
                                        {{ item.Food_Total_restaurant }}

                                    </td>
                                    <td class="whitespace-nowrap text-right">
                                        {{ item.Beverage_Total_restaurant }}

                                    </td>
                                    <td class="whitespace-nowrap text-right">
                                        {{ item.Room_Charges_restaurant }}

                                    </td>
                                    <td class="whitespace-nowrap text-right">
                                        {{ item.Other_Charges_restaurant }}

                                    </td>
                                    <td class="whitespace-nowrap text-right">
                                        {{ item.Service_Charge_restaurant }}

                                    </td>
                                    <td class="whitespace-nowrap text-right">
                                        {{ item.All_Total_restaurant }}

                                    </td>
                                    <td class="text-right">
                                        {{ item.All_Total_ktv + item.All_Total_restaurant }}
                                    </td>
                                </tr>
                            </div>
                            <!-- <tr>
    ...
    export default {
        ...
        methods: {
            ...
            async getPrimaryList(date) {
                const response = await getApiData({ url: `/api/get_sale_ledgers?date=${date}&type=all`, token: this.getToken() });
