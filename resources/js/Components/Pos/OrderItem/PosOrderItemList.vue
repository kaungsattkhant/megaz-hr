<template>
    <div>
                ...
                <div>
                    <div class="bg-white px-4 pb-4">
                        <table class="min-w-full text-left text-sm font-light">
                            ...
                            <tbody>
                                <div class="contents" v-for="(foodOrder, index) in PosOrderItemList" :key=index>
                                    <tr class="">
                                        ...
                                        <td colspan="3" class="whitespace-nowrap px-6 py-3 select-parent">
                                            <select name=""
                                                ...
                                                <option v-for="(area, index) in foodOrder.menu.areas" :key="index"
                                                    :value="area.id" class="">
                                                    {{ area.name }}
                                                </option>
                                            </select>
                                        ...
                                        <td class="whitespace-nowrap px-6 py-3 text-center button-parent">
                                            <button @click="btnClickedAcceptMenu($event, foodOrder.id)">
                                                <i class="fal fa-check text-sm mr-4"></i>
                                            </button>
                                            <button @click="btnClickedRejectMenu($event, foodOrder.id)">
        ...
        <div data-te-modal-init
            ...
            id="confirm_modal" tabindex="-1" aria-labelledby="confirmModalLabel" aria-modal="true" role="dialog">
            <div data-te-modal-dialog-ref
                ...
                <div
                    ...
                    <div class="flex justify-center px-24 py-6 gap-x-8 mb-2">
                        ...
                        <button data-te-modal-dismiss @click="confirmFoodOrder('1')"
...
export default {
    ...
    methods: {
        ...
        async getPosOrderItemList() {
            const response = await getApiData({ url: '/api/pos_order_items', token: this.getToken() });
            if (response.data) {
                this.PosOrderItemList = response.data.data;
                // this.getOrderStatus();
            }
        },
