                ...
                <div
                    ...
                    <div class="relative px-6 py-4 border-b" data-te-modal-body-ref>
                        ...
                        <div class="mb-4">
                            ...
                            <div class="text-sm w-full bg-transparent rounded-lg focus:ring-0" data-te-select-wrapper-ref>
                                <select data-te-select-init data-te-select-placeholder="Menu Category" data-te-select-filter="true"
                                    name="" id=""
                                    class="input-ui">
                                    <option> test</option>
                                </select>
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" placeholder="menu" v-model="name" class="input-ui">
                        </div>
                        <div class="mb-4">
                            <label for="" class="label-form mb-3">
                                Original Price
                            </label>
                            <input type="text" placeholder="Original Price" v-model="name" class="input-ui">
                        </div>
                        <div class="mb-4">
                            <label for="" class="label-form mb-3">
                                Discount Price
                            </label>
                            <input type="text" placeholder="Discount Price" v-model="name" class="input-ui">
                        </div>
                        <div class="mb-4">
                            <label for="" class="label-form mb-3">
                                From
                            </label>
                            <input type="text" placeholder="From" v-model="name" class="input-ui">
                        </div>
                        <div class="mb-4">
                            <label for="" class="label-form mb-3">
                                To
                            </label>
                            <input type="text" placeholder="To" v-model="name" class="input-ui">
                        </div>
                    </div>
