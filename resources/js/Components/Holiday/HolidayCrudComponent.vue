            ...
            <div class="overflow-x-auto">
                <div class="table-container">
                    <table class="primary-table">
                        ...
                        <tbody>
                            <div class="contents" v-for="(holiday, index) in holidayList" :key="index">
                                <tr class="">
                                    ...
                                    <td class="whitespace-nowrap">
                                        <button data-te-toggle="modal" data-te-target="#edit_modal" id="edit-btn"
                                            class="pr-3" @click="editBtnClicked(holiday, index)">
                                            <i class="fal fa-pen"></i>
                                        </button>
                                        <button @click="deleteBtnClicked(holiday.id)" data-te-toggle="modal"
                    ...
                    <div class="flex justify-center">
                        <div v-if="totalData != 0" class=" bg-white  flex justify-center mt-5 py-3">
                            <button class="rounded px-6 py-1 border  hover:bg-slate-200" :disabled="currentPage === 1"
                                @click="getHolidayList(currentPage - 1)">«</button>
                            ...
                            <button class=" rounded px-6  py-1 border  hover:bg-slate-200"
                                :disabled="currentPage === lastPage" @click="getHolidayList(currentPage + 1)">
                                »</button>
                        </div>
                    </div>
                </div>
...
export default {
    ...
    methods: {
        ...
        async getHolidayList(pageNumber) {
            let url = this.url;
