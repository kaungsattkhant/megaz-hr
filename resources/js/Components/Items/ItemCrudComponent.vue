    ...
    <div class="flex justify-between mb-3">
        <div class=" flex">
            ...
            <div class="bg-white mb-0 w-[40%] text-sm inline-block" data-te-select-wrapper-ref>
                <select data-te-select-init data-te-select-placeholder="Filter by category" data-te-select-filter="true"
                    ...
                    <tbody>
                        ...
                        <div class="contents" v-for="(item, itemIndex) in itemList" :key="itemIndex">
                            <tr class="bg-white rounded-lg overflow-hidden shadow-lg">
                                ...
                                <td class="whitespace-nowrap px-6 py-4">
                                    <button id="price-edit-btn" class="pr-2" data-te-toggle="modal" data-te-target="#priceUpdateModal"
                                    @click="updatePriceBtnClicked(item.id)" >
            ...
            <div
                ...
                <div class="relative px-12 py-4" data-te-modal-body-ref>
                    ...
                    <div class="mb-4">
                        ...
                        <input type="number" placeholder="Item Price" v-model="updatedPrice"
                            class="text-sm border border-gray-300 input-ui w-full bg-transparent rounded-lg focus:ring-0">
                    </div>
                </div>
                ...
                <!--Modal footer-->
                <div class="flex justify-center px-12 mb-6">
                    <button type="button" class="add-btn focus:outline-none focus:ring-0 " @click="confirmUpdatePriceBtnClicked"
                        data-te-modal-dismiss>
                        Update Price
                    </button>
                </div>
