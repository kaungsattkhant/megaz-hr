    ...
    <div class="mt-4 bg-white">
        <div class="btn-container mb-2">
            <div class=" flex">
                ...
                <div class="bg-white mb-0 w-[40%] text-xs h-8 border-b border-black rounded-bl-[4px] rounded-br-[4px] overflow-hidden inline-block" data-te-select-wrapper-ref>
        ...
        <div class="block mx-4 mt-4 pb-4">
            <div class="overflow-x-auto">
                ...
                <button type="button" class="mt-4 add-btn transition duration-150 ease-in-out focus:outline-none focus:ring-0 mb-2"
                        ...
                        <div class="relative px-6 py-4 border-b" data-te-modal-body-ref>
                            <div class="mb-4">
                                ...
                                <select name="" id="" v-model="selectedSubAccount"
                                    class="input-ui" @change="subAccountSelectChanged">
                        ...
                        <div class="relative px-6 py-4 border-b" data-te-modal-body-ref v-if="editTransaction">
                            <div class="mb-4">
                                ...
                                <select name="" id="" v-model="selectedEditSubAccount"
                                    class="input-ui" @change="editSubAccountSelectChanged">
                                    <option :value="subAccount" v-for="(subAccount, subAccountIndex) in subAccountList" :key="subAccountIndex">
                                        {{ subAccount.name }}
                                    </option>
                                </select>
