                            ...
                            <tr class="bg-white rounded-lg overflow-hidden shadow-lg">
                                ...
                                <td class="whitespace-nowrap px-6 py-4">
                                    <button id="edit-btn" class="pr-1">
                                        <i class="fas fa-pencil-alt" @click="editBtnClicked(uom)" data-te-toggle="modal"
                                            data-te-target="#edit_modal"></i>
                                    </button>
                                    <!-- <input
            ...
            <div
                ...
                <div class="relative px-12 py-4" data-te-modal-body-ref>
                    <div class="mb-4">
                        ...
                        <select type="text" placeholder="Unit" v-model="baseUnit"
                    ...
                    <div class="mb-4">
                        ...
                        <select type="text" placeholder="Unit" v-model="conversionUnit"
                            class="text-sm border border-gray-300 input-ui w-full bg-transparent rounded-lg focus:ring-0">
                            <option v-for='(uom, index) in uomList' :key=index :value=uom.id>{{ uom.name }}</option>
                        </select>
                    </div>
            ...
            <div
                ...
                <div class="relative px-12 py-4" data-te-modal-body-ref>
                    <div class="mb-4">
                        ...
                        <input type="text" placeholder="Uom" v-model="uom_name"
                            class="text-sm border border-gray-300 input-ui w-full bg-transparent rounded-lg focus:ring-0">
                    </div>
