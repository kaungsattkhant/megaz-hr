...
export default {
    ...
    methods: {
        ...
        async createOffDay(){
            // let selectedRepetitionList = [];
            // this.selectedRepetition.forEach((repetition) => {
            //     selectedRepetitionList.push(String(repetition.value))
            // })
            // this.test1 = selectedRepetitionList;

            let selectedDayList = [];
            this.selectedDay.forEach((day) => {
                selectedDayList.push(String(day.value))
            })
            this.test2 = selectedDayList
