    ...
    <div class="px-0">
        ...
        <div class="grid !grid-cols-12 gap-x-8 gap-y-2 bg-white p-8 rounded-md shadow-md mb-8">
            ...
            <div class="mb-4 col-span-3 rounded-md">
                ...
                <input type="number" v-model="sellingPrice" disabled placeholder="Price" class="input-ui">
            </div>
            <div class="mb-4 col-span-3 rounded-md">
            ...
            <div class="mb-4 col-span-3 rounded-md">
                ...
                <div class="flex gap-x-4">
                    ...
                    <button data-te-toggle="modal" @click="btnClickedCreateMenuCategoryModal" data-te-target="#create_menu_category">
        ...
        <div data-te-modal-init
                ...
                id="create_menu_category" tabindex="-1" aria-labelledby="create_menu_categoryLabel" aria-hidden="true">
                ...
                <div class="min-[576px]:shadow-[0_0.5rem_1rem_rgba(#000, 0.15)] pointer-events-auto relative flex w-full flex-col rounded-md border-none bg-white bg-clip-padding text-current shadow-lg outline-none">
                    <div class="relative flex justify-between py-2 px-6 border-b">
                        <h5 class="text-base text-center mt-2 font-semibold leading-normal font-inter"
                            id="create_menu_categoryLabel">
                            Create Menu Category
                        </h5>
                        <button type="button" class="text-xs focus:shadow-none focus:outline-none"
                                data-te-modal-dismiss aria-label="Close" id="close_menu_category_modal">
                    ...
                    <div class="relative px-6 py-4 border-b" data-te-modal-body-ref>
                        <div class="mb-4">
                            ...
                            <input type="text" placeholder="Menu Category Name" v-model="menu_category_name" class="input-ui">
                        </div>
                        <div class="mb-4">
                            <label for="" class="label-form mb-3">
                                Image
                            </label>
                            <input type="file" class="input-ui" @change="handleMenuCategoryImageChange"
                                accept="image/png, image/gif, image/jpeg" ref="image">
                        </div>

                    </div>
                    <div class="flex justify-end gap-x-4 px-6 mb-6 pt-4">
                        <button type="button" @click="btnClickedCreateMenuCategory"
...
export default {
    ...
    data() {
        return {
            ...
            selectedMenuCategoryImage: null,
        };
    },
    ...
    methods: {
        ...
        handleMenuCategoryImageChange(event) {
            const selectedFile = event.target.files[0];
            this.selectedMenuCategoryImage = selectedFile;
        },
        btnClickedCreateMenuCategory(){
            this.menu_category_name = null;
            this.selectedMenuCategoryImage = null;
        },
        btnClickedCreateMenuCategory(){
            if (!this.menu_category_name) {
                this.alertValidationMessage("Menu Category Name");
                return 1;
            }
            else if (!this.selectedMenuCategoryImage) {
        ...
        async createMenuCategory(){
            ...
            formData.append("name", this.menu_category_name);
            formData.append('image', this.selectedMenuCategoryImage);
            ...
            if (response.success) {
                document.getElementById('close_menu_category_modal').click();
