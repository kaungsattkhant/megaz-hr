<template>
                            ...
                            <div class="contents" v-for="(menu, index) in menuList" :key="index">
                                <tr class="">
                                    ...
                                    <td class="whitespace-nowrap ">
                                        ...
                                        <button class="pr-1 ml-2" type="button" data-te-toggle="modal" data-te-target="#update_price_modal"
                                        @click="updatePriceBtnClicked(menu,index)">
    ...
    <!-- Bank Modal -->
        <div data-te-modal-init
            ...
            id="update_price_modal" tabindex="-1" aria-labelledby="create_modalLabel" aria-modal="true" role="dialog">
                ...
                <div
                    ...
                    <div class="relative px-12 py-4" data-te-modal-body-ref>
                        <div class="mb-4">
                            ...
                            <input type="number" v-model="newPrice" placeholder="Price" class="text-sm border border-gray-300 input-ui w-full bg-transparent rounded-lg focus:ring-0">
                        </div>
                    </div>
...
export default {
    ...
    methods: {
        ...
        confirmUpdatePriceBtnClicked(){
            ...
            postApiData({url: `/api/menus/${this.editId}/prices`, form_data: formData, token: this.getToken()}).then(response=>{
                if(response.data){
