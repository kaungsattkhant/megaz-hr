...
@endif -->
                    ...
                    <li>
                        <a href="{{ route('assetItemList') }}" class="flex items-center @yield('asset_items') sidebar-gap-x">
                    ...
                    <li>
                        <a href="{{ route('fixed_assets.index') }}" class="flex items-center @yield('fixed_asset') sidebar-gap-x">
                    ...
                    <li>
                        <a href="{{ route('room_discount.index') }}" class="flex items-center @yield('room_discount') sidebar-gap-x">
