            ...
            <div class="w-fit h-screen overflow-y-auto pb-20 no-scrollbar border-r border-gray-200" id="icon_sidebar">
                <div class="w-20 sidebar-bg flex flex-col items-center py-6 space-y-4 text-gray-500">
                    ...
                    <div class="flex flex-col space-y-4 w-full items-center">
                        ...
                        <button data-tab="tab-setup" class="tab-btn w-12 h-12 rounded-lg active-nav-item flex items-center justify-center cursor-pointer" title="Set Up">
                            <i class="fal fa-network-wired"></i>
                        </button>
                        <button data-tab="tab-item" class="tab-btn w-12 h-12 rounded-lg active-nav-item flex items-center justify-center cursor-pointer" title="Item">
                            <i class="fal fa-hand-receiving"></i>
                        </button>
                        <button data-tab="tab-hr" class="tab-btn w-12 h-12 rounded-lg active-nav-item flex items-center justify-center cursor-pointer" title="Hr">
                            <i class="far fa-user"></i>
                        </button>
                        <button data-tab="tab-salary" class="tab-btn w-12 h-12 rounded-lg active-nav-item flex items-center justify-center cursor-pointer" title="Salary">
                            <i class="fal fa-file-invoice-dollar"></i>
                        </button>
                        <button data-tab="tab-hr-setup" class="tab-btn w-12 h-12 rounded-lg active-nav-item flex items-center justify-center cursor-pointer" title="Hr Setup">
                            <i class="fal fa-layer-group"></i>
                        </button>
                        <button data-tab="tab-menu" class="tab-btn w-12 h-12 rounded-lg active-nav-item flex items-center justify-center cursor-pointer" title="Menu">
                            <i class="fal fa-salad"></i>
                        </button>
                        <button data-tab="tab-promotion" class="tab-btn w-12 h-12 rounded-lg active-nav-item flex items-center justify-center cursor-pointer" title="Promotion">
                            <i class="fal fa-badge-percent"></i>
                        </button>
                        <button data-tab="tab-financial" class="tab-btn w-12 h-12 rounded-lg active-nav-item flex items-center justify-center cursor-pointer" title="Financial">
                            <i class="fal fa-sack-dollar"></i>
                        </button>
                        <button data-tab="tab-mrp" class="tab-btn w-12 h-12 rounded-lg active-nav-item flex items-center justify-center cursor-pointer" title="MRP">
                            <i class="fal fa-project-diagram "></i>
                        </button>
                        <button data-tab="tab-order" class="tab-btn w-12 h-12 rounded-lg active-nav-item flex items-center justify-center cursor-pointer" title="Order">
                            <i class="fal fa-shopping-bag"></i>
                        </button>
                        <button data-tab="tab-inventory" class="tab-btn w-12 h-12 rounded-lg active-nav-item flex items-center justify-center cursor-pointer" title="Inventory">
                            <i class="fal fa-warehouse"></i>
                        </button>
                        <button data-tab="tab-okr" class="tab-btn w-12 h-12 rounded-lg active-nav-item flex items-center justify-center cursor-pointer" title="Okr">
        ...
        <div class="relative pb-20 small-scrollbar h-[100vh]" onmouseover="this.style.overflowY='auto'"
            ...
            <div class="relative w-[256px] pt-12">
                ...
                <div class="tab-content show" id="tab1">
                    <ul>
                        @if (checkMultipleFeaturePermission(['cash-flow', 'indirect-cash-flow', 'working-capital',
                            'ap-balance']))
                            <li>
                ...
                <div class="tab-content" id="tab-setup">
                    <ul>
                        @if (checkFeaturePermission('department') || checkFeaturePermission('role') ||
                        checkFeaturePermission('area.list') || checkFeaturePermission('room') ||
                        checkFeaturePermission('table') || checkFeaturePermission('inventory') || 
                ...
                <div class="tab-content" id="tab-hr">
                    <ul>
                        @if (checkFeaturePermission('staff') || checkFeaturePermission('okr-duty') ||
                        checkFeaturePermission('meeting') || checkFeaturePermission('training') ||
                        checkFeaturePermission('org-new') || checkFeaturePermission('warning') || 
                        checkFeaturePermission('check-in') || checkFeaturePermission('leave') ||
                        ...
                        @endif
                        @if (checkFeaturePermission('shift-assignment'))
                        <li>
                ...
                <div class="tab-content" id="tab-hr-setup">
                    <ul>
                        @if (checkFeaturePermission('jd') || checkFeaturePermission('js') ||
                        checkFeaturePermission('sop') || checkFeaturePermission('cv') ||
                        checkFeaturePermission('okr') || checkFeaturePermission('time-shift') ||
                        checkFeaturePermission('gps') || checkFeaturePermission('contact') ||
                        checkFeaturePermission('off-day') || checkFeaturePermission('leave-allowance') ||
                        checkFeaturePermission('overtime-fee') || checkFeaturePermission('salary-setup') ||
                        checkFeaturePermission('salary') || checkFeaturePermission('resignation-categories') ||
                        ...
                        @endif
                        @if (checkFeaturePermission('handbook'))
                        <li>
                ...
                <div class="tab-content" id="tab-menu">
                    <ul>
                        @if (checkFeaturePermission('menu-category') || checkFeaturePermission('menu-sale-report') ||
                ...
                <div class="tab-content" id="tab-promotion">
                    <ul>
                        ...
                        checkFeaturePermission('package') || checkFeaturePermission('customer') ||
                ...
                <div class="tab-content" id="tab-financial">
                    <ul>
                        @if (checkFeaturePermission('cashbook') || checkFeaturePermission('journal') ||
                        checkFeaturePermission('staff-balance') || checkFeaturePermission('prepaid') ||
                        checkFeaturePermission('account') || checkFeaturePermission('financial-transaction') ||
                        checkFeaturePermission('asset-item') || checkFeaturePermission('asset') ||
                        checkFeaturePermission('fix-asset') || checkFeaturePermission('ap-balance') ||
                        ...
                        @endif
                        @if (checkFeaturePermission('loan'))
                        <li>
                        ...
                        @endif
                        @if (checkFeaturePermission('accrual'))
                        <li>
                ...
                <div class="tab-content" id="tab-order">
                    <ul>
                        @if (
                        checkFeaturePermission('purchase-order') ||
                        checkFeaturePermission('confirm-purchase-order-item.list')
                ...
                <div class="tab-content" id="tab-inventory">
                    <ul>
                        ...
                        || checkFeaturePermission('inventory-transfer-receive') ||
                        checkFeaturePermission('inventory-transfer') || checkFeaturePermission('used-defected-item')
                        )
                        <li>
                            <p class="sidebar-title">
                                INVENTORY
                ...
                <div class="tab-content" id="tab-okr">
                    ...
                    <li>
                        <a href="/asset_assignment" class="flex items-center @yield('asset_assignment') sidebar-gap-x">
                            ...
                            <!-- hidden old version -->
        <div class="relative pb-20 small-scrollbar h-[100vh] hidden" onmouseover="this.style.overflowY='scroll'"
            onmouseout="this.style.overflowY='hidden'" id="sidebar_scroll_list">
            <div class="relative w-[256px] pt-12">
                <ul class=" mb-4">
                    @if (checkMultipleFeaturePermission(['cash-flow', 'indirect-cash-flow', 'working-capital',
...
@endif -->
                    ...
                    <!-- @if (checkFeaturePermission('task') || checkFeaturePermission('custom-task') ||
                    checkFeaturePermission('report-task'))
                    <li>
                        <p class="sidebar-title">
                            TASKS
                        </p>
                    ...
                    <!-- @if (checkFeaturePermission('package') || checkFeaturePermission('inventory-transfer')
                    )
                    <li>
                        <p class="sidebar-title">
                            PROMOTION
                    ...
                    <!-- @if (checkFeaturePermission('ktv-product-tree') || checkFeaturePermission('menu-forecasting') ||
                    checkFeaturePermission('ktv-forecasting'))
                    <li>
                        <p class="sidebar-title">
                            FACT
                        </p>
                    ...
                    <!-- @if (checkFeaturePermission('time-shift') || checkFeaturePermission('gps') ||
                    checkFeaturePermission('check-in'))
                    <li>
                        <p class="sidebar-title">
                            GENERAL
                        </p>
