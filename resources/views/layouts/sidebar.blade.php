        <nav id="sidebar" class="side-bar w-fit pt-0 h-[100vh]">
            <div class="relative pb-20 overflow-y-hidden small-scrollbar h-[100vh]" onmouseover="this.style.overflowY='scroll'" onmouseout="this.style.overflowY='hidden'">

                <div class="relative w-[15rem] pt-12">
                    <ul class=" mb-4">
                        <li>
                            <button class="flex items-center pl-9 my-2 text-sm w-full" type="button" data-te-collapse-init data-te-ripple-init data-te-ripple-color="light" data-te-target="#collapseFinanceReport" aria-expanded="false" aria-controls="collapseExample">
                                <i class="fal fa-chart-line  pr-3"></i>
                                Finance Report <i class="fas fa-angle-down absolute right-2"></i>
                            </button>
                            <div class="!visible @yield('cash_flow_collapse')hidden text-center" id="collapseFinanceReport" data-te-collapse-item>
                                <ul>
                                    <li>
                                        <a href="/cash_flow_statement" class="flex items-center text-left @yield('cash_flow_statement')">
                                            <i class="fal fa-tasks  pr-3"></i>
                                            Cash Flow
                                        </a>
                                    </li>
                                    <li>
                                        <a href="/indirect_cashflow_statement" class="flex items-center text-left @yield('indirect_cashflow_statement')">
                                            <i class="fal fa-tasks  pr-3"></i>
                                            Indirect Cash Flow
                                        </a>
                                    </li>
                        ...
                        <li>
                            <button class="flex items-center pl-9 my-2 text-sm w-full" type="button" data-te-collapse-init data-te-ripple-init data-te-ripple-color="light" data-te-target="#collapseSaleTargetReport" aria-expanded="false" aria-controls="collapseExample">
                                <i class="fal fa-chart-line  pr-3"></i>
                            ...
                            <div class="!visible @yield('sale_target')hidden text-center" id="collapseSaleTargetReport" data-te-collapse-item>
                                <ul>
                                    <li>
                                        <a href="/sale_target_menu" class="flex items-center text-left @yield('sale_target_menu')">
                                            <i class="fal fa-tasks  pr-3"></i>
                                            Menu
                                        </a>
                                    </li>
                                    <li>
                                        <a href="/sale_target_position" class="flex items-center text-left @yield('sale_target_position')">
                                            <i class="fal fa-tasks  pr-3"></i>
                                            Position
                                        </a>
                                    </li>
                        ...
                        <li>
                            <a href="{{ route('item_usage_forecasts_by_month') }}" class="flex items-center @yield('item_usage_forecasts_month')">
                                <i class="fal fa-truck-loading  pr-3"></i>
                        ...
                        <li>
                            <button class="flex items-center pl-9 my-2 text-sm" type="button" data-te-collapse-init data-te-ripple-init data-te-ripple-color="light" data-te-target="#collapseCashbooks" aria-expanded="false" aria-controls="collapseExample">
                        ...
                        <li>
                            <button class="flex items-center pl-9 my-2 text-sm" type="button" data-te-collapse-init data-te-ripple-init data-te-ripple-color="light" data-te-target="#collapseBankbooks" aria-expanded="false" aria-controls="collapseExample">
                            ...
                            <div class="!visible hidden text-center" id="collapseBankbooks" data-te-collapse-item>
                                <ul>
                                    <li>
                                        <a href="{{ route('kbz_special_bank') }}" class="flex items-center @yield('kbz_special_bank')">
                                            <i class="fal fa-tasks  pr-3"></i>
                                            KBZ Special Account
                                        </a>
                                    </li>
                                    <li>
                                        <a href="{{ route('kbz_old_gm_bank') }}" class="flex items-center @yield('kbz_old_gm_bank')">
                                            <i class="fal fa-tasks  pr-3"></i>
                                            KBZ Old Account (GM)
                                        </a>
                                    </li>
                        ...
                        <li>
                            <a href="{{ route('purchase_orders.left_items_index') }}" class="flex items-center @yield('purchase_order_left_items')">
                                <i class="fal fa-truck-loading  pr-3"></i>
                        ...
                        <li>
                            <a href="{{ route('inventory_stocks.index') }}" class="flex items-center @yield('inventory_stocks')">
                                <i class="fal fa-truck-loading  pr-3"></i>
                                Inventory Stocks
                            </a>
                        </li>
                        ...
                        <li>
                            <a href="{{ route('menu_service_discount.index') }}" class="flex items-center @yield('menu&service_discount')">
                                <i class="fal fa-truck-loading  pr-3"></i>
                        ...
                        <li>
                            ...
                            <div class="!visible hidden text-center" id="collapseCRM" data-te-collapse-item>
                                <ul>
                                    <li>
                                        <a href="{{ route('crm.customers.index') }}" class="flex items-center @yield('crm_customer_list')">
                                            <i class="fal fa-tasks  pr-3"></i>
                                            Customers
                                        </a>
                                    </li>
                                    <li>
                                        <a href="{{ route('crm.customers.birthdays') }}" class="flex items-center @yield('customer_birthdays')">
                                            <i class="fal fa-tasks  pr-3"></i>
                                            Customer Birthdays
                                        </a>
                                    </li>
                                    <li>
                                        <a href="{{ route('crm.level_discounts.index') }}" class="flex items-center @yield('customer_level_discounts')">
                                            <i class="fal fa-tasks  pr-3"></i>
                                            Customer Level Discounts
                                        </a>
                                    </li>
                                    <li>
                                        <a href="{{ route('crm.birthday_discounts.index') }}" class="flex items-center @yield('birthday_promotions')">
                                            <i class="fal fa-tasks  pr-3"></i>
                                            Birthday Promotions
                                        </a>
                                    </li>
            ...
            <div id="app" class="absolute bottom-0 left-0 w-[15rem] h-14 bg-[#111c43] border-t border-[#0002] flex items-center justify-start">
                <logout-component />
            </div>
        </nav>
